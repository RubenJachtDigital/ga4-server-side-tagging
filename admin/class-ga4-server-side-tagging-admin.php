        ...
        <div class="wrap">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <form method="post" style="display: inline-block;">
                    ...
                    <button type="submit" class="button button-secondary" onclick="return confirm('Are you sure you want to clear the logs?');">
                        Clear Logs
                    </button>
                </form>
            </div>
            ...
            <div class="card">
                ...
                <?php else : ?>
                    ...
                    <div style="background: #f6f6f6; padding: 10px; border: 1px solid #ddd; overflow: auto; max-height: 500px; font-family: monospace; white-space: pre-wrap; font-size: 12px;">
